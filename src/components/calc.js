...
export default function Calc() {
    ...
    useEffect(() => {
        ...
        if (p !== undefined && p !== null && boostedPool !== undefined && boostedPool !== null) {
            ...
            const baseJoeRewardsPerSec = poolsJoePerSec * 0.50
            ...
            setCurrentBoostedAPR(calcBoostedAPR(p, userLiq, currentVeJoeBal, joePriceInUSD))
            setEstimatedBoostedAPR(calcBoostedAPR(p, userLiq, joeStake, joePriceInUSD))
        }
    ...
    function calcBoostedAPR(p, userLiq, veJoe, joePriceInUSD) {
        ...
        const userBoostedRewardsPerSec = (userFarmFactor * joePerSecond * 0.5) / totalFarmFactor
        ...
        const boostedAPR = ((userBoostedRewardsPerYear / (10**18) * joePriceInUSD) / p.reserveUSD) * 100
